...
userinit(void)
{
	 ...
	 */
	addpages(p, nil, USTKTOP-USTKSIZE, USTKSIZE, SG_STACK|SG_READ|SG_WRITE, 1);
	sno = 0;
	 ...
	 * Text
	 */
	addpages(p, nil, UTZERO, BIGPGSZ, SG_TEXT | SG_READ, 1);
	 ...
	 * Data
	 */
	addpages(p, nil, UTZERO + BIGPGSZ, BIGPGSZ, SG_DATA | SG_READ|SG_WRITE, 1);
